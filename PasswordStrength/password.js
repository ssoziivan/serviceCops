...
//                 if(value.indexOf(symbol) > -1){
//                     containsSymbol = true;
//                     // We have found the symbol.Therefore return false to exit
//                     return false;
//                 }
//             });
//             return containsSymbol;
...
//         function getStrengthClass(score) {
//             var strengthIndex = parseInt(Math.round(score * (strengthClassNames.length - 1) * 100 / settings.secureStrength) / 100,10);
//             if (strengthIndex >= settings.strengthClassNames.length){
//                 strengthIndex = settings.strengthClassNames.length - 1;
//             }
//             return settings.strengthClassNames[strengthIndex];
